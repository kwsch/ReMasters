...
namespace ReMastersLib {
    ...
    static BattleRewardReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::ReMastersLib.BattleReward), global::ReMastersLib.BattleReward.Parser, new[]{ "BattleRewardId", "Exp", "Coins", "U4", "RewardPresetIds" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::ReMastersLib.BattleRewardTable), global::ReMastersLib.BattleRewardTable.Parser, new[]{ "Entries" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      rewardPresetIds_.WriteTo(ref output, _repeated_rewardPresetIds_codec);
      if (_unknownFields != null) {
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 42:
          case 40: {
            rewardPresetIds_.AddEntriesFrom(ref input, _repeated_rewardPresetIds_codec);
            break;
          }
        }
      }
